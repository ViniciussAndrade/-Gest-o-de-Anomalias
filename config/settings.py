...
LOGIN_URL = 'login'  # URL para redirecionar quando o utilizador não está autenticado
LOGIN_REDIRECT_URL = 'anomalias:lista_anomalias'  # Para onde vai após login com sucesso
